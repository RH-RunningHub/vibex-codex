...
Depending on the requested operation, the service may process project identifiers, safe project metadata, selected source paths and content, bounded patches, preview state, and publication choices. The plugin does not request unrelated browser history, passwords, everyday browser profiles, arbitrary local files, or credentials.
